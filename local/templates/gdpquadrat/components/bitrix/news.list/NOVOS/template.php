...
?>
<div id="rec123321244545534" class="r t-rec t-rec_pt_90 t-rec_pb_90" style="padding-top:90px;padding-bottom:90px; " data-animationappear="off" data-record-type="670">
   <div class="t670">
         ...
         <div class="t-container t-slds__main">
            <div class="t-slds__container t-width t-width_9 t-margin_auto">
               <div class="t-slds__items-wrapper t-slds_animated-none t-slds__witharrows" data-slider-transition="300" data-slider-with-cycle="true" data-slider-correct-height="true" data-auto-correct-mobile-width="false" data-slider-arrows-nearpic="yes" data-slider-initialized="true" data-slider-totalslides="6" data-slider-pos="4" data-slider-curr-pos="4" data-slider-cycle="" data-slider-animated="" style="width: 6880px; height: 550px; transform: translateX(-3440px); touch-action: pan-y; -webkit-user-drag: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0);">
				...
				<div class="naz"><?=$item["NAME"]?>
			 <div class="data"><?=$item["DISPLAY_ACTIVE_FROM"]?></div>
				 <div class="anons"><?=$item["PREVIEW_TEXT"]?> <a href="<?=$item["DETAIL_PAGE_URL"]?>" class="podrobnee">подробнее</a></div>
			</div>
   ...
   <script type="text/javascript"> $(document).ready(function() { t670_init('123321244545534'); t_sldsInit('123321244545534'); }); $('.t670').bind('displayChanged',function(){ t_slds_updateSlider('123321244545534'); t_slds_positionArrows('123321244545534'); }); </script>
   <style type="text/css"> #rec123321244545534 .t-slds__bullet_active .t-slds__bullet_body { background-color: #222 !important; } #rec123321244545534 .t-slds__bullet:hover .t-slds__bullet_body { background-color: #222 !important; }</style>
</div>