...
?>
<div class="part location_block_wr row py-lg-5 g-4 g-lg-5 align-items-center">
	<div class="left_block col-12 col-lg-6 col-xxl-6 wow slideInLeft" data-wow-delay=".4s">
	...
	<div class="right_block col-12 col-lg-6 mt-5 mt-lg-0 wow slideInRight" data-wow-delay=".4s">
