...
<div class="invest_form" data-ym-goal="<?=$ymGoal?>">
	<div class="row">
	<div class="col-lg-5 col-xl-5 col-12">
		<?if(SITE_ID == "s1"):?>
			<h2 class="invest_form_title">Возникли вопросы? <br>Готовы ответить</h2>
		<?else:?>
			<h2 class="invest_form_title">Do you have any questions? <br>We're here to help.</h2>
		<?endif;?>
	</div>
		...
		<div class="row g-3">
			...
			<?foreach($arResult["QUESTIONS"] as $FIELD_SID => $arQuestion):?>
				...
				<?if($class != 'type_checkbox'):?>
                    ...
                    <? $colClass = ($FIELD_SID === 'email') ? 'col-lg-12' : 'col-lg-6';?>
