...
<!-- Google Tag Manager -->
	...
	})(window,document,'script','dataLayer','GTM-MWTVVGGG');</script>
...
<noscript><div><img src="https://mc.yandex.ru/watch/87218877" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<!-- /Yandex.Metrika counter -->
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-MWTVVGGG"
		...
		<div class="row justify-content-between">
			...
			<div class="col-auto d-none d-xl-block">
				<div class="info_header">
					<div class="header_phone"><a href="tel: +74951351893">+7 (495) 135-18-93</a></div>
					...
					<div class="header_lang">
						...
						<?else:?>
							...
							?>
							<a href="/" class="title">РУС</a><span>|</span><span class="selected">ENG</span>
						<?endif;?>
					</div>
				</div>
			</div>
			<div class="col-auto d-xl-none d-block">
				<div class="header_mobile">
					<div class="header_lang">
						...
						<?else:?>
							<a href="/" class="title">РУС</a>
						<?endif;?>
					</div>
					<div class="header_phone">
						<a href="tel: +74951351893">
					...
					<div class="header_burger">
						<a href="tel: +74951351893">
							<svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
								...
								<rect y="7" width="17" height="3" fill="black"/>
								<rect y="14" width="17" height="3" fill="black"/>
							</svg>
						</a>
					</div>
			</div>
...
<div class="header">
    <div class="block_inner">
        <div class="logo_header">
            <?if(SITE_ID == "s1"):?>
                <a href="/"  class="mob"><img itemprop="logo" src="/local/templates/gdpquadrat/images/LogoRUSW.svg" alt="Company"></a>
            <?else:?>

                <a href="/" class="mob"><img itemprop="logo"  src="/local/templates/gdpquadrat/images/LogoENGW.svg" alt="Company"></a>
            <?endif;?>
            ...
            <?else:?>
                <?if(SITE_ID == "s1"):?>
                    <a href="/" itemprop="url" class="pc">
                        <img itemprop="logo" src="<?=$APPLICATION->GetTemplatePath('images/LogoRUS.svg')?>" alt="Company">
                    </a>
                <?else:?>
                    <a itemprop="url" href="/en/" class="pc" >
                        <img itemprop="logo" src="<?=$APPLICATION->GetTemplatePath('images/LogoENG.svg')?>" alt="Company">
                    </a>
                <?endif;?>
            <?endif;?>
        </div>
	...
	"ACTIVE_COMPONENT" => "Y"
            ...
            <div class="phone_block"><a href="tel: +74951351893" style="color: #000080;">+7 (495) 135-18-93</a></div>
            <div class="lang_block">
                <?if(SITE_ID == "s1"):?>
				<span>РУС</span><span>|</span><a href="/en/" class="title">ENG</a>
                <?else:?>
                    <?
                    $url = str_replace ( "/en" , "", $APPLICATION->GetCurPage(false));
                    ?>
				<a href="/" class="title">РУС</a><span>|</span><span>ENG</span>
                <?endif;?>
            </div>
        </div>
        <div class="burger">
