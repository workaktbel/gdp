...
$rsSections = CIBlockSection::GetList(array('SORT' => 'ASC'), $arFilter, false, array("UF_TITLE_1", "UF_TITLE_2", "UF_CARD_TEXT", "UF_TITLE_1_EN", "UF_TITLE_2_EN", "UF_CARD_TEXT_EN", "UF_DESCRIPTION_EN"));
...
<div class="map_wrap">
	...
	<div class="container-xxl list_items">
		<?if(SITE_ID == "s1"):?>
	...
	$rsSections = CIBlockSection::GetList(array('SORT' => 'ASC'), $arFilter, false, array("UF_NAME_EN"));
	while ($arSection = $rsSections->GetNext()) {
