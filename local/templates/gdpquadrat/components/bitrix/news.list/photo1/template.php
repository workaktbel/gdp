...
<div class="t-container" style="padding-bottom:90px;
            margin: 0 auto;
position: relative">
    <div class="  hnovosti ">
				...
				<?foreach($arResult['ITEMS'] as $key => $item):?>
                    ...
                    <li class=" slide" >
                        <div class="slide-block">
                            <img class="slide-img" src='<?=$item["DETAIL_PICTURE"]["SRC"]?>'></img>
                            <div class="slider-text" >
                                <div class="slide-title"><?=$item['NAME']?></div>
                                <div class="slide-date">
									<?echo date("d.m.Y", strtotime($item['DATE_CREATE']))?>
                                </div>
								<div class="slide-description"><?=$item['DETAIL_TEXT'];?> <? if ($item["PROPERTIES"]["SSYLKA"]["VALUE"]){?> <a href="<?=$item["PROPERTIES"]["SSYLKA"]["VALUE"]?>"><?=$item["PROPERTIES"]["NAZVANIESSYLKY"]["VALUE"]?></a><?}?> </div>
    ...
    display: inline-block;
        ...
        #rec123321244545534 .t-slds__bullet_active .t-slds__bullet_body { background-color: #222 !important; } #rec123321244545534 .t-slds__bullet:hover .t-slds__bullet_body { background-color: #222 !important; }</style>
</div>