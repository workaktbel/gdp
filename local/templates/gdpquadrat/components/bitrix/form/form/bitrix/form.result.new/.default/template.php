...
<div class="invest_form my_form" data-ym-goal="<?=$ymGoal?>">
	<div class="row">
	<div class="col-lg-5 col-xl-5 col-12">
		<div class="invest_form_title"><?= $arParams["TITLE"];?></div>
	</div>
	<div class="col-lg-7 col-xl-7 col-12">
		...
		<div class="row g-3 mt-2 123">
			<div class="col">
                <label for="conf-d" class="conf">
                    <input type="checkbox" class="conf__input js-enabled-submit" id="conf-d" checked>
				<div class="invest_form_law">Отправляя данную форму,вы соглашаетесь на обработку <a href="https://drive.google.com/file/d/1Tv-YlvRtoqD0AHGB6BnIlEmi5wRQmREL/view" target="_blank">персональных данных</a></div>
                </label>
			</div>
...
$(document).ready(function () {
    var ymGoal = '<?=$ymGoal?>';
    var $formContainer = $('.invest_form[data-ym-goal="' + ymGoal + '"]');
    ...
    $form.on('submit', function() {
        var checkInterval = setInterval(function() {
            if ($formContainer.find('.hideForm').length > 0 && !goalSent) {
                goalSent = true;
