...
<div class="container-xxl address_page">
	...
	<div class="row">
		<div class="col-lg-5 col-12 order-lg-1 order-2">
			<div class="address_page_wrap">
				...
				<div class="address_page_item">
					...
					<span class="address_page_item_value"><?=$arResult["PROPERTIES"]['PHONE']['~VALUE'][0]['TEXT']?><span class="signs">,</span> <?=$arResult["PROPERTIES"]['PHONE']['~VALUE'][1]['TEXT']?></span>
				</div>
				<div class="address_page_item">
					<div class="address_page_item_icon">
		...
		<div class="offset-xl-1  col-lg-6 col-12 order-lg-2 order-1">
