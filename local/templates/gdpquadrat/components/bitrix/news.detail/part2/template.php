...
?>
<div class="new_stup_wr  part part2 row g-4 g-lg-5">
	<div class="left_block col-12 col-lg-6 mt-lg-0 wow slideInLeft" data-wow-delay=".4s">
	...
	<div class="right_block col-12 col-lg-6 wow slideInRight" data-wow-delay=".4s">
		<h2 class="part_title"><?=$arResult["NAME"]?></h2>
		<div class="part_description"><?=$arResult["PREVIEW_TEXT"]?></div>
		<div class="row gy-4 gy-lg-5">
			<div class="pe-5 col-lg-6 col-12">
